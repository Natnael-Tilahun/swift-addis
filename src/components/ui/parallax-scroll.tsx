...
export const ParallaxScroll = ({
  ...
  return (
    ...
    >
      <div
        className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 items-start max-w-7xl mx-auto gap-10 py-40 px-10"
        ref={gridRef}
      >
        ...
        <div className="grid gap-10">
          {thirdPart.map((el, idx) => (
            <motion.div style={{ y: translateFirst }} key={"grid-3" + idx}>
              <Image
                src={el}
                className="h-80 w-full object-cover object-left-top rounded-lg gap-10 !m-0 !p-0"
                height="400"
